...
export const PlusIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height="18" fill={'currentColor'} viewBox="0 -960 960 960" width="18">
      <path strokeWidth={'10px'} d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z" />
    </svg>
  );
};
