...
export class Curve {
  public name: string;
  public equationSvg: any;
  public a: Parameter;
  public b: Parameter;
  public c: Parameter;
  public d: Parameter;
  public k: Parameter;
  public generateY: (x: number, a: number, b: number, c: number, d: number, k: number) => number;
  /*
    ...
    @example: new Curve('Linear', <Linear />, 1, 1, 0, 0, 1, (x: number) => x)
  */
  constructor(
    name: typeof this.name,
    equationSvg: typeof this.equationSvg,
    a: typeof this.a,
    b: typeof this.b,
    c: typeof this.c,
    d: typeof this.d,
    k: typeof this.k,
    generateY: typeof this.generateY
  ) {
    this.name = name;
    this.equationSvg = equationSvg;
    this.a = a;
    this.b = b;
    this.c = c;
    this.d = d;
